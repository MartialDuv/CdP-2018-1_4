...
| T19 | Création des tests de validation des USs. Ces tests seront effectués avec Puppeteer et Travis pour permettre de les automatiser. | à préciser | à préciser | #4 | x | TO DO | Mary | 0.5 |
